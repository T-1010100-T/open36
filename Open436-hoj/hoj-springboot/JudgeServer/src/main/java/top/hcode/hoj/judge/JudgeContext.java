...
public class JudgeContext {
    ...
    public Judge Judge(Problem problem, Judge judge) {
        ...
        if (languageConfig == null) {
            ...
            finalJudgeRes.setStatus(Constants.Judge.STATUS_SYSTEM_ERROR.getStatus());
            finalJudgeRes.setErrorMessage("Unsupported language: " + judge.getLanguage());
            finalJudgeRes.setTime(0);
            finalJudgeRes.setMemory(0);
