  ...
  <div class="admin-container">
    <div v-if="!mobileNar">
      ...
      >
        ...
        <el-menu-item @click="goToOpen436Admin">
          <i class="fa fa-arrow-left fa-size" aria-hidden="true"></i
          >返回 Open436 后台
        </el-menu-item>
      ...
      <mu-drawer :open.sync="opendrawer" :docked="false" :right="false">
        <mu-list toggle-nested>
          ...
          <mu-list-item
            button
            :ripple="true"
            @click="goToOpen436Admin"
          >
            <mu-list-item-action>
              <mu-icon value=":fa fa-arrow-left" size="24"></mu-icon>
            </mu-list-item-action>
            <mu-list-item-title>返回 Open436 后台</mu-list-item-title>
          </mu-list-item>
